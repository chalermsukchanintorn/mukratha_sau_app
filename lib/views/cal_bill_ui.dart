...
import 'package:mukratha_sau_app/views/show_bill_ui.dart';
...
class _CalBillUIState extends State<CalBillUI> {
  ...
  //สร้างตัวแปรเก็บค่ารายการที่เลือก
  String memberTypeSelect = 'ไม่เป็นสมาชิก';
  //สร้างตัวแปรเก็บส่วนลดที่เลือกจากประเทภสมาชิก
  double discount = 0;
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () {
                          ...
                          if (imgFile == null) {
                            ...
                            //แจ้งเตือน
                          } else if (childCheck == true && childCtrl.text == '0' || childCtrl.text.length == 0) {
                            //แจ้งเตือน
                          } else {
                            //พร้อมคำนวณ
